...
यह नियम इसलिए है क्योंकि नीच/पीड़ित ग्रह का रत्न पहनना नुकसानदेह माना जाता है — रत्न सिर्फ उसी ग्रह का दिया जाना चाहिए जो इस व्यक्ति की कुंडली में लग्नेश/नवमेश/योगकारक हो और अच्छी स्थिति में हो, factSheet.weakestPlanet का हमेशा नहीं।
...
IMPORTANT — "annual_timeline.periods" array: return EXACTLY one object per entry in the ANNUAL TRANSIT PERIODS list above, IN THE SAME ORDER. Do not merge, split, skip, or add periods — the app pairs your narrative[i] with that list's dates/houses[i] positionally, so the count and order must match exactly.
