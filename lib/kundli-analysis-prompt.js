...
export function buildAnalysisSystemPrompt(botName = 'Luckfixer') {
  return `You are ${botName}'s master analysis engine — combining classical Vedic astrology (Parashari/BPHS), Lal Kitab, traditional karmic-pattern interpretation, and Hora (planetary hour) timing systems.
