  ...
  for (const p of sorted) {
    ...
    if (p.isCurrent) {
      questions.push({
        ...
        lord: p.adLord,
        question: `${startLabel} से ${p.mdLordHi} महादशा में ${p.adLordHi} की अंतर्दशा चल रही है। इस दौरान ${theme.good} — क्या ऐसा कुछ अनुभव हुआ?`,
      ...
      questions.push({
        ...
        lord: p.adLord,
        question: `${startLabel} से ${endLabel} के बीच (${p.mdLordHi} महादशा में ${p.adLordHi} अंतर्दशा) — ${theme.good}, क्या ऐसा कुछ हुआ था?`,
        followup: `या ${theme.hard} — कुछ ऐसा?`,
